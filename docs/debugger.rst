...
**sCrypt IDE** 自带一个功能强大的调试器。你可以用它来调试 **.scrypt** 源代码。如果您购买了高级付费功能，您还可以用它来进行比特币脚本级别的调试。
...
与一般语言（比如c++/javascript)不同， 启动 **sCrypt IDE** 的 debugger 必须配置启动参数。这是 **sCrypt** 语言的结构特性决定的，如下图：
